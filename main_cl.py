...
def run(args, verbose=False):
    ...
    output_file = open("{}/{}bsz {}rbsz {}iters {}ctemp contr-{} {}clr {}drop {}recrep {}reclam.txt".format(args.r_dir, args.batch, args.batch_replay, args.iters, args.c_temp, args.contrastive, args.contr_lr, args.c_drop, args.recon_repulsion, args.lamda_rep), 'a+')
    output_file.write('\nAccuracy of final model on test-set:')
    for i in range(args.tasks):
    ...
    if param_tuning:
        f_out = open("{}/tuning/MNIST/lam_rep_f6_js/{}.txt".format(args.r_dir, args.repl), 'a+')
